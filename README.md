...
```powershell
cd D:\dev\my-project\wenxuan-skills\source-router\scripts
...
```powershell
cd D:\dev\my-project\wenxuan-skills\creator-capture\scripts
...
```powershell
cd D:\dev\my-project\wenxuan-skills\account-brain\scripts
...
```powershell
cd D:\dev\my-project\wenxuan-skills
python codex-image-studio\scripts\generate_image_via_local_api.py --prompt "极简中文知识海报，米白底，深棕标题，卡片布局" --out output\sample.png
```
