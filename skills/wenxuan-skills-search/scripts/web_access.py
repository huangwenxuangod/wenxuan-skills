...
from env_utils import find_project_root, load_wenxuan_runtime_env
...
load_wenxuan_runtime_env(PROJECT_ROOT, cwd=Path.cwd(), skill_root=BASE_DIR)
...
def save_result(result: Dict[str, Any], *, prefix: str, key: str) -> Dict[str, str]:
    ...
    latest_json_path = output_dir / f"{prefix}-result.json"
    latest_md_path = output_dir / f"{prefix}-result.md"
